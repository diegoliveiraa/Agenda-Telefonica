...
public class PhonesAdapter extends RecyclerView.Adapter<PhonesAdapter.ListAdapterViewHolder> {
    ...
    public PhonesAdapter(ItemClickListener listener) {
        mClickListener = listener;
        mContacts = new ArrayList<>();
    }

    public PhonesAdapter(@NonNull List<Contact> contacts, ItemClickListener listener) {
        mContacts = contacts;
        mClickListener = listener;
